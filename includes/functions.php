<?php 
    ...
    function find_defaul_page_for_subject($subject_id) {
    ...
    function find_selected_page($public=false) {
        ...
        if (isset($_GET["subject"])) {
            ...
            if ($current_subject && $public) {
                $current_page = find_defaul_page_for_subject($current_subject["id"]);
            } else {
                $current_page = null;
            }
    ...
    function generate_salt($lenght) {
        ...
        $modified_base64_string = str_replace('+', '-', $base_string);
